		...
		<form class="layui-form">
			...
			<div class="layui-form-item" >
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" id="typeId" lay-verify="required" autocomplete="off" placeholder="房间编号" class="layui-input" readonly>
					</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" id="price" lay-verify="number" autocomplete="off" placeholder="￥" class="layui-input" readonly>
					</div>
				</div>
			...
			layui.use(['form', 'layedit', 'laydate'], function() {
				...
				form.on('submit(insertRome)', function(data) {
					...
					var params = "orderId=" + orderId + "&orderName=" + orderName + "&orderPhone=" + orderPhone +
						...
						"&orderMoney=" + orderMoney + "&deposit=" + deposit + "&operatorId=" + operatorId + "&remark=" + remark + "&make=1";

					$.post('${pageContext.request.contextPath}/order/insertOrderInfo.do', params, function(data) {
						if(data === '1') {
							layer.alert('预订单登记成功！', {
								title: '新增成功',
								icon: 6,
