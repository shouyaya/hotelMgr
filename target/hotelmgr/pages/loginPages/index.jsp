...
<head>
    <meta charset="utf-8">
    <title>宾馆管理系统</title>
    <link rel="stylesheet Icon" type=" image/x-icon" href="${pageContext.request.contextPath}/img/windows.ico">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/login/register-login.css">
...
<div class="cent-box">
    ...
    <div class="cent-box-header">
        <h1 class="main-title">HotelMgr</h1>
        <h2 class="sub-title">宾馆管理系统</h2>
    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/login/particles.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/login/background.js"></script>
        ...
        $(document).ready(function() {
            ...
            $('#btnLogin').click(function() {
                ...
                if(loginName === "")
                    ...
                    //发出ajax请求，调用后端功能
                    $.post('${pageContext.request.contextPath}/login/checkLogin.do', params, function(data) {
                        if(data === '-1')
                            layer.msg("用户名不存在", {
                                anim: 6
                            });
                            ...
                            //根据写入的session值得到结果
                            $.post('${pageContext.request.contextPath}/login/setLoginInfo.do', function(loginInfo) {
                            ...
                            setTimeout(function() {
                                location.href = '${pageContext.request.contextPath}/login/loginToList.do';
                            }, 1000); //等待一段时间后跳入
